"""
Django settings for test_issue_dev_110384 project.
...
ROOT_URLCONF = 'test_issue_dev_110384.urls'
...
WSGI_APPLICATION = 'test_issue_dev_110384.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "test_issue_dev_110384 API",
    "DESCRIPTION": "API documentation for test_issue_dev_110384 App",
    "VERSION": "v1",
}
