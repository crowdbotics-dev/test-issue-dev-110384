...
## Project Structure
    ...
    ├── test_issue_dev_110384  # Django project configurations
...
1. Clone this repo and `cd test_issue_dev_110384`
...
2. Clone this repo and `cd test_issue_dev_110384`
